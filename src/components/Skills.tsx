...
//       <div className="grid grid-cols-2 md:flex md:items-center md:flex-wrap md:justify-center gap-4 lg:gap-6">
//         {mySkills?.map((item) => (
//           <div
//             key={item.id}
//             className="py-2 px-4 bg-gradient-to-tr from-white to-cyan-50 border rounded-full flex items-center gap-2 lg:gap-4"
//           >
//             <Image
//               src={item.img}
//               alt={item.title}
