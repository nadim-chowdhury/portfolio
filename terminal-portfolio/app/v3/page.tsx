...
const EXPERIENCE: Experience[] = [
  {
    ...
    points: [
      ...
      "Developed secure REST APIs for reliable client-server communication",
  ...
  },
  {
    ...
    points: [
      ...
      "Designed responsive UI components using React, Ant Design, and Bootstrap, consuming GraphQL APIs",
    ],
  },
  {
